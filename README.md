...
**JetPack 4.4 NOTE:** the minimum version that will build correctly on JetPack 4.4 GA is 4.5.0. Prior versions of JetPack may need the CUDNN version adjusted (the `-D CUDNN_VERSION='8.0'` line can simply be removed).
